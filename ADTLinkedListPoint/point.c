...
/* Menghasilkan true jika point 1 sama, jika tidak maka false */
{
    return (P1.x == P2.x) && (P1.y == P2.y);
}

boolean pointBT(POINT P1, POINT P2)
/* Menghasilkan true jika point 1 lebih besar, jika tidak maka false */
{
    return (P1.x > P2.x && P1.y > P2.y) || (P1.x == P2.x && P1.y > P2.y) || (P1.x > P2.x && P1.y == P2.y);
}

boolean pointLT(POINT P1, POINT P2)
/* Menghasilkan true jika point 1 lebih kecil, jika tidak maka false */
{
    return (!(pointEQ(P1, P2))) && (!(pointBT(P1, P2)));
}
